...
class GPModel(object):
    ...
    def __init__(self,
        ...
        # Keep the user-requested likelihood string for compatibility checks in Python wrappers.
        self._user_likelihood = None if likelihood is None else str(likelihood)
        ...
        lik_c    = c_str(likelihood) if likelihood is not None else None
    ...
    def fit(self, y, X=None, params=None, offset=None, fixed_effects=None):
        ...
        is_custom_gaussian_like = self._user_likelihood in ("poisson_gamma", "gamma_gamma", "weibull_inverse_gamma")
        if ((self.num_cov_pars == 1 and self._get_likelihood_name() == "gaussian" and self.gp_approx != "vecchia_latent" and not is_custom_gaussian_like) or
