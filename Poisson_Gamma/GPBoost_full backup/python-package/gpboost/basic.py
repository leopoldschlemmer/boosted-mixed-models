...
class GPModel(object):
    ...
    def fit(self, y, X=None, params=None, offset=None, fixed_effects=None):
        ...
        is_poisson_gamma = (self._user_likelihood == "poisson_gamma")
        if ((self.num_cov_pars == 1 and self._get_likelihood_name() == "gaussian" and self.gp_approx != "vecchia_latent" and not is_poisson_gamma) or
