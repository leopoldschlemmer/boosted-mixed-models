	...
	*/
	...
	public:
		...
		*/
		...
		/*!
		* \brief Calculate test negative log-likelihood for the custom Poisson-Gamma grouped model
		* \param y_test Test response variable
		* \param fixed_effects_test Fixed-effects predictor on the test data
		* \param num_data Number of test data points
		*/
		double TestNegLogLikelihoodPoissonGamma(const label_t* y_test,
